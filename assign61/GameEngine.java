...
public class GameEngine implements TimedEventHandler, Serializable {
	...
	/*
	 * OLD CODE public Set<String> getOptions() { // TODO Auto-generated method stub
	 * //LUOKAN SISÄÄN???? anna komennot //Set interface doesn't allow add, a
	 * concrete set is required HashSet<String> hs= new
	 * HashSet<String>(myPlayer.getCurrentSpace().getOptions()); hs.add(ENDCOMMAND);
	 * hs.add(SAVECOMMAND); hs.add(TAKECOMMAND);
	 * 
	 * //name of an object in player's inventory can be used as the first part of a
	 * command for (String key:myPlayer.getInventory().keySet()) { hs.add(key); }
	 * return hs; }
	 */
